...
public class PaymentMethodService {
    ...
    /**
     * Get all the paymentMethods with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<PaymentMethodDTO> findAllWithEagerRelationships(Pageable pageable) {
        return paymentMethodRepository.findAllWithEagerRelationships(pageable).map(paymentMethodMapper::toDto);
    }
    ...
    public Optional<PaymentMethodDTO> findOne(Long id) {
        ...
        return paymentMethodRepository.findOneWithEagerRelationships(id).map(paymentMethodMapper::toDto);
    }
