package com.example.parkinglot.aop.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut(
        "within(com.example.parkinglot.repo..*)" +
        " || within(com.example.parkinglot.service..*)" +
        " || within(com.example.parkinglot.web.rest..*)"
    )
