...
describe('Alert service test', () => {
  describe('Alert Service Test', () => {
    ...
    it('should produce an alert object with correct id', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Hello info' });
      expect(service.addAlert({ type: 'success', message: 'Hello success' })).toEqual(
        expect.objectContaining({
          type: 'success',
    ...
    it('should close an alert correctly', inject([AlertService], (service: AlertService) => {
      const alert0 = service.addAlert({ type: 'info', message: 'Hello info' });
      const alert1 = service.addAlert({ type: 'info', message: 'Hello info 2' });
      const alert2 = service.addAlert({ type: 'success', message: 'Hello success' });
    ...
    it('should clear alerts', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Hello info' });
      service.addAlert({ type: 'danger', message: 'Hello info' });
      service.addAlert({ type: 'success', message: 'Hello info' });
      expect(service.get().length).toBe(3);
      service.clear();
      expect(service.get().length).toBe(0);
    }));
    ...
    it('should produce a success message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'success', message: 'Hello' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello',
        } as Alert),
    ...
    it('should produce a success message with custom position', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'success', message: 'Hello', position: 'bottom left' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello',
    ...
    it('should produce a error message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'danger', message: 'Hello' })).toEqual(
        expect.objectContaining({
          type: 'danger',
          message: 'Hello',
        } as Alert),
    ...
    it('should produce a warning message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'warning', message: 'Hello' })).toEqual(
        expect.objectContaining({
          type: 'warning',
          message: 'Hello',
        } as Alert),
    ...
    it('should produce a info message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'info', message: 'Hello' })).toEqual(
        expect.objectContaining({
          type: 'info',
          message: 'Hello',
        } as Alert),
